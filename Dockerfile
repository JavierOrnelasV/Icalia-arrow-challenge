...
ARG IMAGE_NAME="icalia-arrow-challenge:latest"

LABEL org.label-schema.build-date=$BUILD_DATE \
      org.label-schema.name="Icalia-arrow-challenge" \
      org.label-schema.description="icalia-arrow-challenge" \
      org.label-schema.vcs-url="https://github.com/IcaliaLabs/icalia-arrow-challenge.git" \
